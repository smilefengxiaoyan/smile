...
"border:outset;")
    ...
    def retranslateUi(self, alter_display_staff):
        ...
        self.lineEdit.setText(_translate("alter_display_staff", "HRGUY INFO"))
        ...
        item.setText(_translate("alter_display_staff", "workID"))
        item = self.tableWidget.item(0, 1)
        item.setText(_translate("alter_display_staff", "Name"))
        item = self.tableWidget.item(0, 2)
        item.setText(_translate("alter_display_staff", "Invitaion"))
        item = self.tableWidget.item(0, 3)
        item.setText(_translate("alter_display_staff", "left quota"))
