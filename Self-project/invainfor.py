...
"border:outset;")
    ...
    def retranslateUi(self, alter_display_staff):
        ...
        self.lineEdit.setText(_translate("alter_display_staff", "Inva INFO"))
        ...
        item.setText(_translate("alter_display_staff", "In_ID"))
        item = self.tableWidget.item(0, 1)
        item.setText(_translate("alter_display_staff", "Name"))
        item = self.tableWidget.item(0, 2)
        item.setText(_translate("alter_display_staff", "Subject"))
