...
"border-radius:3px;")
    ...
    def retranslateUi(self, login):
        ...
        login.setWindowTitle(_translate("login", "HRD-Admin"))
        self.sno.setPlaceholderText(_translate("login", "User_number"))
        self.pwd.setPlaceholderText(_translate("login", "Password"))
        self.btn.setText(_translate("login", "login"))
